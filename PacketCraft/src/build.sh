...
Code="../../src/main.cpp ../../src/Utils.cpp ../../NetworkUtils.cpp ../../src/Packet.cpp ../../src/DNSParser.cpp"
...
g++ -shared -o ../lib/libpacketcraft.so utils.o network_utils.o packet.o dnsparser.o
